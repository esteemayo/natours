...
var stripe = Stripe('pk_test_GGtwP3i2MudVjz4ZXRkw2yFG00rIhLjXZe');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); // 2) Create checkout form + charge credit card (automatically)
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault(); // document.querySelector('.btn--save-password').innerHTML = 'Updating...';
            ...
            document.getElementById('password-confirm').value = ''; // document.querySelector('.btn--save-password').innerHTML = 'Save password';
...
if (bookBtn) bookBtn.addEventListener('click', function (e) {
  ...
  var tourId = e.target.dataset.tourId; //Destructured tourId because they have the sane name
